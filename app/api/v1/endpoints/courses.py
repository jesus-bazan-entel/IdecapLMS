...
def _course_to_response(course_id: str, data: dict) -> CourseResponse:
    ...
    return CourseResponse(
        ...
        price_status=data.get("priceStatus") or data.get("price_status", "free"),
        price=data.get("price", 0.0),
        author=author,
        course_meta=course_meta,
        category_id=data.get("categoryId") or data.get("category_id"),
        tag_ids=data.get("tagIds") or data.get("tag_ids", []),
        tutor_ids=data.get("tutorIds") or data.get("tutor_ids", []),
